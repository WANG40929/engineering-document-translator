...
---------------
  ...
  release\DocumentTranslator-v1.4.1-Windows-Setup-Full.exe
  release\DocumentTranslator-v1.4.1-Windows-Portable-Full.zip
  release\DocumentTranslator-v1.4.1-Windows-Portable-Lite.zip
...
------------------------
  ...
  powershell -ExecutionPolicy Bypass -File .\scripts\build_release.ps1 `
    -Version 1.4.1 -LiteOnly -SkipInstaller
