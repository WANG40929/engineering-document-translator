...
---------------
  ...
  release\DocumentTranslator-v1.4.3-Windows-Setup-Full.exe
  release\DocumentTranslator-v1.4.3-Windows-Portable-Full.zip
  release\DocumentTranslator-v1.4.3-Windows-Portable-Lite.zip
...
------------------------
  ...
  powershell -ExecutionPolicy Bypass -File .\scripts\build_release.ps1 `
    -Version 1.4.3 -LiteOnly -SkipInstaller
